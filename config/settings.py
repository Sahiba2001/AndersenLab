...
SECRET_KEY = 'django-insecure-o4%^req90j(0#8+icyy-ob1dwjwd$whxi*6@39(6@d=#@q29br'
...
#     'REFRESH_TOKEN_LIFETIME': config('JWT_REFRESH_TOKEN_LIFETIME', default=86400, cast=int),
